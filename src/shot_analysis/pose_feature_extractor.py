...
class PoseFeatureExtractor:
    ...
    def extract_hit_window_features(
        ...
        Args:
            frames: Full video frames list.
            player_boxes: Player bounding boxes across all frames.
            hit_frame: Frame index of the hit event.
            player_id: Player ID (1 = near court, 2 = far court).
            handedness: Player handedness.
            window_half_size: Frames before/after hit frame to analyze.
            crop_margin: Margin fraction to expand bounding box crop.
            
        Returns:
            Dict containing pose feature summary and confidence.
        """
        ...
        for f_idx in range(start_f, end_f + 1):
            ...
            try:
                ...
                if handedness == PlayerHandedness.RIGHT_HANDED:
                    # Right wrist position relative to right shoulder
                    dom_wrist_dx = (r_wr[0] - sh_mid_x) / sh_width
                else:
                    # Left wrist position relative to left shoulder
