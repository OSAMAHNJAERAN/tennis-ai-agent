...
def main():
    ...
    folders = [base/'uvy_player_fragment_linking_pilot01', base/'uvy_motion_fragment_linking_pilot01']
    ...
    for folder in folders:
        ...
        cases.append(('tennis_V03', {'predecessor': 4, 'successor': 230, 'end_frame': 380, 'start_frame': 383, 'rejected_target': True}))
