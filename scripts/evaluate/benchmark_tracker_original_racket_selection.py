"""Original-racket control from verified ByteTrack/BoT-SORT caches."""
import argparse
import json
import math
import os
...
def main():
    ...
    cv2.setNumThreads(1)
    protocol = ROOT/'docs/experiments/TRACKER_ORIGINAL_RACKET_SELECTION.md'
    sources = ['scripts/evaluate/benchmark_tracker_original_racket_selection.py', 'scripts/evaluate/benchmark_racket_pilot04_restricted.py',
