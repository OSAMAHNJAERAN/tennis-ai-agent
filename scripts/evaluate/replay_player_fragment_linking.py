...
def main():
    ...
    protocol = ROOT/'docs/experiments/PLAYER_FRAGMENT_LINKING.md'
    report = {'complete': False, 'qualification_evidence': False, 'scope': 'OFFLINE_BOUNDARY_IOU_FRAGMENT_LINKING_DEVELOPMENT_REPLAY',
              ...
              'configuration': {'maximum_elapsed_seconds': .2, 'minimum_boundary_iou': .5, 'tie_tolerance': 1e-9,
              ...
              'code_hashes': {name: digest(ROOT/name) for name in (
                  'scripts/evaluate/replay_player_fragment_linking.py', 'src/tracking/player_fragment_linking.py',
